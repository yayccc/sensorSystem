...
void MainWindow::setupDatabase()
{
    ...
    QSqlQuery query;
    query.exec("CREATE TABLE IF NOT EXISTS sensors (id INTEGER PRIMARY KEY, name TEXT, type TEXT, timestamp TEXT, value REAL)");
}
...
void MainWindow::on_updateButton_clicked()
{
    ...
    if (!query.exec()) {
        QMessageBox::critical(this, "Error", "Failed to update sensor");
    } else {
        model->select();
    }
}
...
void MainWindow::on_clearDataButton_clicked()
{
    ...
    reply = QMessageBox::question(this, "清空数据", "是否清空数据?", QMessageBox::Yes | QMessageBox::No);
